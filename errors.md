...
Give a valid IPv4 address. For instructions to fix this problem, see TBD

## validation_invalid_ipv6_address
**Message**: The value is not a valid IPv6 address.

Give a valid IPv6 address. For instructions to fix this problem, see TBD
...
Supply a smaller value. For instructions to fix this problem, see TBD

## validation_min_value
**Message**: The value supplied was too small.

Supply a larger value. For instructions to fix this problem, see TBD

## validation_not_null
**Message**: The field supplied must be null.

Be sure the value is null. For instructions to fix this problem, see TBD
...
You may need to check your premissions and contact your administrator. For instructions to fix this problem, see TBD

## security_group_interfaces_attached
**Message**: Cannot delete the security group while interfaces are attached.

Be sure all interfaces are deleted. For instructions to fix this problem, see TBD

## security_group_remoting_rules
**Message**: Cannot delete the security group while remoting rules are attached.

Be sure to remove all remoting rules. For instructions to fix this problem, see TBD
...
Be sure to disassociate the floating IP before you delete the server. For instructions to fix this problem, see TBD
...
For instructions to fix this problem, see the TBD [Need a good link here, of the form shown](https://www.{DomainName}/docs/troubleshoot/ts_accessing.html#ts_err){: new_window} troubleshooting topic.
